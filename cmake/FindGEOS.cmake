...
ELSE(WIN32)
 ...
 IF(UNIX)
    ...
    IF (GEOS_CONFIG)
      ...
      IF (APPLE)
        SET(GEOS_C_LIBRARY ${GEOS_LINK_DIRECTORIES}/lib${GEOS_LIB_NAME}.dylib CACHE STRING INTERNAL)
      ELSE (APPLE)
       SET(GEOS_C_LIBRARY ${GEOS_LINK_DIRECTORIES}/lib${GEOS_LIB_NAME}.so CACHE STRING INTERNAL)
      ENDIF (APPLE)
      IF (APPLE)
        SET(GEOS_LIBRARY ${GEOS_LINK_DIRECTORIES}/libgeos.dylib CACHE STRING INTERNAL)
      ELSE (APPLE)
       SET(GEOS_LIBRARY ${GEOS_LINK_DIRECTORIES}/libgeos.so CACHE STRING INTERNAL)
      ENDIF (APPLE)
